...
import br.com.dio.domain.service.PessoaService;
...
public class PessoaController {
	...
	@PutMapping("/{estadoId}")
	public ResponseEntity<Pessoa> atualizar(@PathVariable String estadoId,
			@RequestBody Estado estado) {
		Pessoa pessoaAtual = pessoaRepository.findById(estadoId).orElse(null);
